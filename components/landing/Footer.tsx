...
import { Fingerprint, Github, Linkedin, Twitter } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-24">
          <div className="md:col-span-1">
            ...
            <div className="flex gap-4">
              {[Github, Twitter, Linkedin].map((Icon, index) => (
                <Link key={index} href="#" className="w-12 h-12 flex items-center justify-center border border-white/5 rounded-xl text-white/20 hover:text-gemigram-neon hover:border-gemigram-neon/50 hover:bg-gemigram-neon/5 transition-all group">
          ...
          {[
            ...
            <div key={column.title}>
              <h4 className="text-[10px] font-black uppercase tracking-[0.4em] mb-10 text-white/80">{column.title}</h4>
